...
<template>
    <div class="relative isolate overflow-hidden min-h-screen flex items-center justify-center">
        ...
        <div class="mt-6 px-6 py-4 shadow-md sm:max-w-md sm:rounded-lg bg-transparent bg-opacity-90">
            <slot />
        </div>
    </div>
</template>